...
- !!! 위의 말을 시작으로 자기 소개 시작하면 좋을 것 같음. 본인이 개발하면서 지향하는 부분을 강조하면서
...
## !!! 여기에
 - 경력을 쓰기 전에 지금까지 경험했던 것을 대력적으로 먼저 소개하는게 좋을 것 같음.
 - 예를 들어
 - Back-end 역량
    - Java, Spring 을 이용한 RESTful API 서버 개발
    ...
    - AWS cloud 환경에 익숙함
        ...
        ..
        ..
- Front-end 역량 (BE 역량보다는 적게)
    - ..
    - ..
    - ..
- !!! 이렇게 한번 한눈에 파악할 수 있게 쓰고
- !!! 그 뒤에 경력 기술
- !!! 단, 경력 기술은 최대한 간단하게.
- !!! 길게 적어봤자 안보고 피곤해함.
- !!! 지금 작성하신 긴 경력 내용은 포트폴리오로 따로 정리.
